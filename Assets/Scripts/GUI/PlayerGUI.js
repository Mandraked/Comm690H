...
private var headsetAudio : HeadsetAudioManager;
...
function Start () {
	...
	curAudio = headsetAudio.GetCurrentSample();
...
function OnGUI() {
	if(wearingSpaceSuit || MainScript.currentScene == 1){
		...
		//Audio
		GUI.Label(new Rect(Screen.width-35, maxAudio-audioBarLength+10, 25, audioBarLength), GUIContent.none, foregroundStyle);
